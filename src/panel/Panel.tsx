...
export const Panel: React.FC = () => {
  ...
  const [selectedMapping, setSelectedMapping] = useState<ElementMapping | null>(null);
  ...
  console.log(networkCalls, mappings, addMapping, removeMapping, 'initial values');
  ...
  return (
    ...
    >
      <h1>API Mapper Panel</h1>
      <Toolbar />
      <div className="flex flex-1 overflow-hidden">
        <div className="w-1/2 p-4 overflow-auto">
          <h2 className="text-lg font-semibold mb-4">Network Calls</h2>
          <NetworkList 
            calls={networkCalls}
